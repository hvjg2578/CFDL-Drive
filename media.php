...
<?php
  echo "<div class=container>";
   ...
   if($rewrite)
   {
       echo "<a class='btn btn-success' href='".$information['site_url'] ."/".rawurlencode(substr_replace(rawurldecode($_GET['url']),"",0,1))."'".'>'."下载此文件</a>";
   }
   else
   {
  ...
  {
      $url=$information['site_url'] .str_replace("./","/",$localdir)."/".rawurlencode(substr_replace(rawurldecode($_GET['url']),"",0,1));
  ...
  {
        $srcurl= $information['site_url'].str_replace("./","/",$localdir).rawurldecode($_GET['url']);
  ...
  else if(checkvalue(".md",$_GET['url']))
  {
        ...
        $srcurl=$information['site_url'] .str_replace("./","/",$localdir)."/".rawurlencode(substr_replace(rawurldecode($_GET['url']),"",0,1));
  ...
  {
        $srcurl=$information['site_url'] .str_replace("./","/",$localdir).rawurlencode(rawurldecode($_GET['url']));
        echo "<div class=container>";
        echo "<div class='typo subbox table-fluid'>";
